...
def create_model(
    ...
    # supposed to implement essentially a smoothing function on the spike rate but doesn't work atm
    if neuron_output:
        ...
        print("Output_spikes shape before slicing:", output_spikes.shape)
        ...
        print("Output shape before slicing:", output.shape)
        print("Thresh shape before slicing:", thresh.shape)
